...
class Settler(reactor_ASM1):
    ...
    def masa(self):
        recykl = self.recykl()
        self.Xbh2 = ((self.Xbh1 * self.V) + self.Xbhw - (self.Xbh1 * self.Qw)) / self.V
        self.Xba2 = ((self.Xba1 * self.V) + self.Xbaw - (self.Xbh1 * self.Qw)) / self.V
        self.Ss2 = ((self.Ss1 * self.V) + (self.Ssd * self.Qd) - (self.Ss1 * self.Qw)) / self.V
        self.Xs2 = ((self.Xs1 * self.V) + self.Xsw - (self.Xs1 * self.Qw)) / self.V
        self.Xp2 = ((self.Xp1 * self.V) + self.Xp - (self.Xp1 * self.Qw)) / self.V
        self.Xnd2 = ((self.Xnd1 * self.V) + self.Xndw - (self.Xnd1 * self.Qw)) / self.V
        self.Snd2 = ((self.Snd1 * self.V) + (self.Sndd * self.Qd) - (self.Snd1 * self.Qw)) / self.V
        self.Snh2 = ((self.Snh1 * self.V) + (self.Snhd * self.Qd) - (self.Snh1 * self.Qw)) / self.V
        self.Sno2 = ((self.Sno1 * self.V) + (self.Snod * self.Qd) - (self.Sno1 * self.Qw)) / self.V
        self.So2 = ((self.So1 * self.V) + (self.Sod * self.Qd) - (self.So1 * self.Qw)) / self.V
